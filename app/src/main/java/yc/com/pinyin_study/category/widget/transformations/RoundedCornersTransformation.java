package yc.com.pinyin_study.category.widget.transformations;
...
//    canvas.drawBitmap(toTransform,new Rect(margin, margin, width-margin, height-margin),new Rect(margin, margin, width-margin, height-margin),paint);
